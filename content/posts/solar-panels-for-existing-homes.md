...
Panel cleaning gets overstated by installers. Rain handles most of the work in most climates. In dry regions like Southern California, Arizona, or Texas, dust and bird droppings can cut output 5 to 15 percent if ignored for months. A [basic solar panel cleaning kit](https://www.amazon.com/s?k=solar+panel+cleaning+kit&tag=contentportfo-20) makes this a straightforward once or twice yearly task if you're comfortable on your roof. Use deionized or distilled water to skip mineral deposits.

A [home energy monitor](https://www.amazon.com/s?k=home+energy+monitor&tag=contentportfo-20) like the Emporia Vue or Sense adds useful visibility. These show real-time consumption by circuit, so you can see whether you're actually using your solar production or exporting most of it and importing again at peak rates. That data helps you shift habits: run the dishwasher or EV charger during peak solar hours.
