...
date: 2026-05-19T12:26:49.560237+00:00
draft: false
...
This one drives me crazy because I've seen it go badly wrong for homeowners. Solar installations require permits. Full stop. The permit triggers an inspection by your local building or electrical department, which is the official check that the system was installed to code. Skipping it is illegal, and it creates serious problems down the road.

If you sell your house, an unpermitted solar system will almost certainly surface during the buyer's inspection or title search. You may be forced to bring it into compliance at your own expense or disclose it as a defect. More immediately, your homeowner's insurance policy may not cover damage related to an unpermitted electrical installation.
...
1. **Get the license number in writing.** Ask the salesperson or the company's office. No legitimate company will hesitate.
2. **Verify the license online.** Find your state's contractor licensing board and confirm active status, license type, and any disciplinary history.
3. **Request a certificate of insurance.** Ask them to have their insurance carrier send it directly to your email address. This is standard practice in the trades.
4. **Search NABCEP.** Go to nabcep.org and check if the company or any of their lead installers are certified.
5. **Look up reviews on multiple platforms.** Don't stop at Google. Check the Better Business Bureau, Yelp, and especially the CFPB complaint database (cfpb.gov). Look for patterns in negative reviews, not just star counts.
6. **Pull the proposal apart.** Every piece of equipment should have a manufacturer name and model number. If it doesn't, ask for it in writing before you sign.
7. **Confirm the permitting plan.** Ask specifically who pulls the permit and how you'll receive documentation of the final inspection.
8. **Check for HOA requirements.** If you have an HOA, many have rules about panel placement, color, and visibility. Some require HOA approval before installation. Your installer should know this and factor it in. If they've never mentioned it, that's a gap in their process.
9. **Talk to a past customer.** Ask the company for references from jobs in your zip code from the past 12 months. Then actually call. Ask how the permitting went, whether the system produces what was promised, and how the company handled any issues.
10. **Compare proposals on price per watt.** Divide the total system cost by the total system size in watts. In 2024, a fair range for a fully permitted residential system with quality equipment is roughly $2.50 to $3.50 per watt before incentives. Significantly below that range warrants scrutiny. So does anything above $4.50 without a clear reason.

| What to Check | How to Verify | Red Flag |
|---|---|---|
| Contractor license | State licensing board website | No license, expired, or wrong type |
| Insurance | Direct from insurer via email | Expired policy or refusal to provide |
| NABCEP certification | nabcep.org directory | False claim or unlisted |
| Equipment specs | Proposal document | Generic terms, no brand names |
| Permit plan | Ask in writing | "We don't need one" or vague answer |
| Reviews | BBB, CFPB, Google, Yelp | Pattern of production or installation complaints |
| Price per watt | Simple math on the proposal | Below $2.50 or above $4.50 without explanation |

## What Happens If Something Goes Wrong After Installation

Even a legitimate, licensed installer can have issues. Equipment fails, production underperforms, or workmanship problems show up six months after installation. Knowing your recourse ahead of time matters.

First, understand the difference between the equipment warranty and the workmanship warranty. Equipment warranties come from the manufacturer. A reputable panel like a SunPower or REC panel carries a 25-year product and performance warranty. Inverters vary: string inverters typically carry 10 to 12 year warranties, while microinverters from companies like Enphase carry 25 years. Your installer's workmanship warranty covers the installation itself, typically for 5 to 10 years from a reputable company.
