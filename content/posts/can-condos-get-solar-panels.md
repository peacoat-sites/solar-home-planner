...
faqs:
 - q: "Can an HOA legally prevent me from installing solar panels on my condo?"
...
| Factor | Single-Family Home | Condo Unit |
| --- | --- | --- |
| Roof Ownership | Owner | HOA/Collective |
| Electrical Connection | Main panel in home | Shared infrastructure, separate metering |
| Approval Required | None (self-owned property) | HOA board vote |
| Interconnection Complexity | Direct utility connection | Coordination with HOA, utility, electrician |
| Typical Bill Savings | 70-80% | Varies; rooftop 50-80%, community solar 5-15% |
| Permitting | Homeowner responsibility | HOA coordination required |
...
If you're in a state without strong solar access protections, your options narrow considerably. Your governing documents, specifically the CC&Rs (Covenants, Conditions, and Restrictions) and the Declaration, will be the controlling texts. Read them carefully before doing anything else. Look for language about exterior modifications, roof access, and common area alterations.

A few practical checks before you spend a dollar:

- Pull your state's solar rights statute (a quick search for "[your state] solar access law" usually gets you there)
- Read your condo's CC&Rs front to back
- Check whether your association has any existing solar policy or has approved past installations
- Talk to an HOA attorney for an hour if the language is ambiguous. It's worth the $200-300 consult fee.

## The Community Solar Alternative: Often the Real Answer for Condo Owners

Here's what I recommend to most condo owners before they even start the HOA fight: look at [community solar](/solar-for-flat-roof-homes/) first.
...
| Option | Ownership | HOA Approval Needed | Typical Savings | Availability |
|---|---|---|---|---|
| Rooftop panels on your unit | You own the system | Yes, and often difficult | 50-80% of electric bill | Depends on HOA and state law |
| Community solar subscription | No ownership | No | 5-15% of electric bill | ~20 states currently |
