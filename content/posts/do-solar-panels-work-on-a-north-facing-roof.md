---
title: "North Facing Solar Panels: How Much Power Do They Generate?"
...
slug: "do-solar-panels-work-on-a-north-facing-roof"
affiliate_disclosure: true
faqs:
  - q: "Can you put solar panels on a north-facing roof?"
    a: "Yes, you physically can. But in most of the continental U.S., a north-facing installation will produce 35 to 55 percent less energy than a south-facing system at the same size and pitch. Whether that's acceptable depends on your shading situation, local net metering rules, and what alternatives you have for panel placement."
  - q: "How much less efficient are north-facing solar panels?"
    a: "At a typical 30-degree roof pitch in the mid-latitudes, a north-facing system produces roughly 40 to 50 percent less annually than a south-facing equivalent. At a shallower pitch (under 15 degrees), the production gap narrows to around 20 to 30 percent because the panels are closer to horizontal and catch more diffuse sky radiation."
  - q: "What's the best roof orientation for solar panels in the U.S.?"
    a: "True south (azimuth 180°) at a pitch angle roughly equal to your latitude is the textbook answer. In practice, anything from southeast to southwest (roughly azimuth 135° to 225°) with a 15 to 40 degree pitch is workable. East and west are usable but less ideal. North is a last resort."
  - q: "Will my solar installer tell me if my roof faces the wrong direction?"
...
The other one: installers who size the system large to compensate for poor orientation. "We'll just put up more panels" sounds reasonable until you realize you're paying for 14 kW of north-facing panels to do the work of a 9 kW south-facing system. You're paying more for less efficient use of your roof and your money. The [U.S. Department of Energy's homeowner guide to going solar](https://www.energy.gov/eere/solar/homeowners-guide-going-solar) covers system sizing basics, but it won't tell you when an installer is padding a quote to compensate for a bad site. That part takes a little experience to recognize.

## Sources

- [NREL PVWatts Calculator](https://pvwatts.nrel.gov/): NREL's free tool for estimating solar production by location, tilt, and azimuth. The most credible quick-modeling resource available to homeowners.
- [EnergySage Solar Market Intelligence](https://news.energysage.com/): Tracks installer pricing, net metering policy changes, and market trends. Current as of 2026.
- [U.S. Department of Energy, Homeowner's Guide to Going Solar](https://www.energy.gov/eere/solar/homeowners-guide-going-solar): Federal resource covering system sizing, financing, and installer vetting basics.
- [NREL, "Solar Resource Data" (Technical Reports)](https://www.nrel.gov/solar/solar-resource-assessment.html): Source for regional solar irradiance and peak sun hour data used in production estimates.
