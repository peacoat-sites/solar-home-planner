...
faqs:
  - q: "Can I add EV charging to an off-grid solar system?"
    a: "You can, but it changes the math significantly. An EV charging at Level 2 draws 7.2 kW and might need 30 to 60 kWh to refill from empty. That can nearly double your daily load. Most off-grid EV owners use a Level 1 charger (1.4 kW) and charge slowly overnight when the battery bank is well-stocked, or they add dedicated EV charging capacity to their solar array sizing. A J1772 Level 1/Level 2 EV charger with adjustable amperage settings lets you throttle your charging rate to match what your system can support. (This site may earn a commission on qualifying purchases.)"
  - q: "How long do off-grid solar systems last?"
    a: "Quality solar panels carry 25 to 30-year production warranties and realistically last longer. LiFePO4 batteries typically carry 10-year warranties and 3,000 to 6,000 cycle ratings, which translates to 8 to 16 years of daily use before they drop to 80% capacity. Inverters are typically warranted for 5 to 10 years. Plan for battery replacement as your single largest maintenance cost over the system's lifetime."
  - q: "Do I still need a permit if my property is rural or unincorporated?"
    a: "In most cases, yes. Unincorporated doesn't mean unregulated. County building departments typically have jurisdiction over rural parcels, and the NEC still applies to any electrical installation inside a structure. Some extremely rural parcels in specific states have no local authority having jurisdiction (AHJ), but that's the exception. Always call your county building department before assuming no permit is required."
  - q: "What's the minimum viable off-grid system for a small cabin or tiny home?"
...
### Can I add EV charging to an off-grid solar system?

You can, but it changes the math significantly. An EV charging at Level 2 draws 7.2 kW and might need 30 to 60 kWh to refill from empty. That can nearly double your daily load. Most off-grid EV owners use a Level 1 charger (1.4 kW) and charge slowly overnight when the battery bank is well-stocked, or they add dedicated EV charging capacity to their solar array sizing. A [J1772 Level 1/Level 2 EV charger](https://www.amazon.com/s?k=j1772+ev+charger+level+2&tag=solarsite-20) with adjustable amperage settings lets you throttle your charging rate to match what your system can support. *(This site may earn a commission on qualifying purchases.)*

### How long do off-grid solar systems last?

Quality solar panels carry 25 to 30-year production warranties and realistically last longer. LiFePO4 batteries typically carry 10-year warranties and 3,000 to 6,000 cycle ratings, which translates to 8 to 16 years of daily use before they drop to 80% capacity. Inverters are typically warranted for 5 to 10 years. Plan for battery replacement as your single largest maintenance cost over the system's lifetime.

### Do I still need a permit if my property is rural or unincorporated?

In most cases, yes. Unincorporated doesn't mean unregulated. County building departments typically have jurisdiction over rural parcels, and the NEC still applies to any electrical installation inside a structure. Some extremely rural parcels in specific states have no local authority having jurisdiction (AHJ), but that's the exception. Always call your county building department before assuming no permit is required.

### What's the minimum viable off-grid system for a small cabin or tiny home?

A well-designed tiny home running LED lighting, a small refrigerator, a laptop, phone charging, and a modest water pump can often get by on 3 to 5 kWh per day. That opens the door to a much smaller system: 2 to 3 kW of panels, a 10 kWh LiFePO4 battery bank, and a 2,000-watt inverter/charger. Total equipment cost in that range runs $8,000 to $15,000, and it's a manageable DIY project for someone with solid electrical knowledge.

### How do I know if a solar installer is qualified for off-grid work?

Ask directly: how many off-grid systems have you designed and installed in the last two years? A grid-tied specialist can install panels, but off-grid system design requires specific knowledge of battery management, charge controller programming, and load analysis. Look for NABCEP (North American Board of Certified Energy Practitioners) certification. Ask for references from off-grid clients specifically. And review the proposed single-line diagram yourself. If they can't explain every component in plain terms, that's a red flag.
