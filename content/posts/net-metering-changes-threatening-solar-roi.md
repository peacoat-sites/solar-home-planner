...
slug: "net-metering-changes-threatening-solar-roi"
affiliate_disclosure: true
faqs:
  - q: "Is net metering still available in most states?"
    a: "As of July 2026, yes, the majority of states still have some form of net metering, but the terms vary enormously. Several large states including California have already shifted to lower export rates, and active proceedings in more than a dozen states could further change the picture within the next two to three years. Check DSIRE for your specific state's current rules before making any financial projections."
  - q: "Will existing solar customers be affected by net metering changes?"
    a: "Usually not immediately. Most states that have restructured net metering have included grandfathering provisions that lock in existing customers at their original rate for a set period, often 10 to 20 years from their interconnection date. However, grandfathering terms vary, and some states have been less generous. Read your specific utility's interconnection agreement carefully."
  - q: "Does adding a battery fix the net metering problem?"
    a: "Partially. A battery lets you store excess solar for self-consumption instead of exporting it at a low rate, which reduces how much the export rate matters to your economics. But batteries add significant upfront cost, and the math only works out clearly if you're in a market with favorable time-of-use rates or frequent outages. Run the numbers for your specific utility's rate structure."
  - q: "How should I evaluate a solar quote given uncertain future export rates?"
...
If you want to track your home's energy flows before committing to a battery, a home energy monitor like the [Emporia Vue or Sense Home Energy Monitor](https://www.amazon.com/s?k=home+energy+monitor) (affiliate link, site may earn a commission) will show you exactly how much you're currently exporting versus using. I've recommended this to probably a dozen clients now as the first step before pulling the trigger on any storage decision.
...
- [DSIRE USA](https://www.dsireusa.org/): Database of State Incentives for Renewables and Efficiency, updated continuously, tracks net metering policies by state
- [EnergySage Market Data](https://news.energysage.com/): Solar marketplace annual data on installation costs, battery pricing, and contractor quotes nationwide
- [U.S. Department of Energy, Office of Energy Efficiency and Renewable Energy](https://www.energy.gov/eere/solar/homeowners-guide-going-solar): Homeowner's guide with federal incentive and policy framework overview
- [California Public Utilities Commission, NEM 3.0 Decision](https://docs.cpuc.ca.gov/): The CPUC's April 2023 final decision restructuring California's net metering tariff
