---
title: "Solar Installer Background Checks: What Companies Must Verify"
date: 2026-08-04T23:32:42.375369+00:00
draft: false
description: "Learn what background checks solar installers need, why they matter for homeowners, and what to expect during the vetting process."
image: "/img/heroes/33379360.jpg"
categories: ["Solar Contractor Selection"]
tags: ["solar", "installer", "background", "check", "tips"]
author: "David Torres"
...
slug: "solar-installer-background-check-tips"
affiliate_disclosure: true
faqs:
  - q: "How do I verify a solar contractor's NABCEP certification?"
    a: "Go to nabcep.org and use the 'Verify a Certificate Holder' tool. Search by the individual installer's name, not the company name. Certifications are issued to individuals, not businesses."
  - q: "What should a solar installer's workmanship warranty minimally cover?"
    a: "At minimum, 10 years on labor. Some top-tier installers offer 25 years. The warranty should explicitly cover roof penetration leaks, wiring defects, and mounting hardware failure. Get it in writing and confirm the warranting entity is the same company signing your contract."
  - q: "Is it safe to hire a newer solar company with limited review history?"
    a: "Possibly, but do more verification, not less. Check their license issue date, pull their permit history at the county level, and confirm they carry adequate insurance with current active status. A two-year-old company with a clean permit record and NABCEP installers can outperform a ten-year company that's coasting on old reviews."
  - q: "What happens to my warranty if my solar installer goes out of business?"
    a: "The equipment manufacturer warranties (panels, inverters) remain valid regardless. The workmanship warranty typically dies with the company unless they've purchased third-party warranty insurance. Ask specifically before signing: 'Who backs your workmanship warranty if your company closes?'"
  - q: "Do solar installers need to pull permits, and what happens if they don't?"
    a: "Yes, in virtually every U.S. jurisdiction, a grid-tied solar installation requires a permit and final inspection. Unpermitted systems can cause problems when you sell your home, may violate your homeowner's insurance policy, and will likely need to be removed or brought up to code at your expense. Always ask for the permit number after it's issued and confirm final inspection passes."
---
...
Here's what I wish someone had told me before I saw my first nightmare installation: the solar industry has almost no meaningful barrier to entry. In most states, a general electrical contractor's license is technically sufficient to pull a solar permit. That's a problem, because pulling wire in a panel and designing a grid-tied 10 kW system with optimizers and a [battery backup](/generator-vs-solar-battery-backup/) are not the same skill set.


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">NABCEP PV Installation Professional certification is the single most reliable credential to require from your installer.</li><li style="margin:5px 0">A solar contractor should carry at least $1,000,000 in general liability and $1,000,000 in workers' comp, verify directly with their insurer, not just their word.</li><li style="margin:5px 0">Pulling a permit history for a contractor takes about 10 minutes at your county building department and is one of the highest-signal checks you can do.</li><li style="margin:5px 0">Salespeople and installers are often different companies; get the full legal name of the entity that will physically install and the entity that will warranty the work.</li><li style="margin:5px 0">Complaints filed with your state contractor's licensing board are public record and rarely show up in Google reviews.</li></ul></div>
...
Some states layer additional requirements on top. California requires a C-46 Solar contractor license or a C-10 Electrical license. Florida requires a certified solar contractor (CMC or CVC specific to solar) *or* a licensed EC. Texas is one of the more permissive states: an TECL is required but solar-specific training is not. Know your state's rules. The [National Renewable Energy Laboratory (NREL)](https://www.nrel.gov/) publishes a state-by-state licensing requirements summary that's worth bookmarking.
...
This step takes maybe 20 minutes total and [most homeowners](/the-july-4-solar-deadline-most-homeowners-dont-know-about/) skip it entirely. Don't.
...
The permit history check is separate and, honestly, more informative. Call or visit your county building department. Give them the contractor's business name. Ask how many [solar permits](/solar-permits-by-state-requirements/) they've pulled in the past two years, and how many passed final inspection on the first attempt. Most building departments will tell you. A contractor who fails final inspection repeatedly is either cutting corners or doesn't know the code. I've called building departments where the clerk volunteered "oh, we know that company, they have a lot of re-inspections" without me even asking.
...
| Coverage Type | Minimum I'd Require | Why |
|---|---|---|
| General Liability | $1,000,000 per occurrence | Covers property damage, roof penetration errors, falling equipment |
| Aggregate Liability | $2,000,000 | Total season/project cap; some small firms carry only $500K aggregate |
| Workers' Compensation | $1,000,000 | If a laborer falls off your roof without it, you could be liable |
| Auto/Commercial Vehicle | $500,000 | Equipment vans, trailers, mounting racks on public roads |
| Completed Operations | Check it's included | Covers defects discovered after installation is "done" |
...
- [NABCEP (North American Board of Certified Energy Practitioners)](https://www.nabcep.org/): Official NABCEP credential lookup and PV Installation Professional requirements.
- [National Renewable Energy Laboratory (NREL)](https://www.nrel.gov/): State-by-state solar contractor licensing summary and market research.
- [EnergySage Market Data](https://news.energysage.com/): Solar installer pricing benchmarks, quote comparisons, and market trends.
- [National Electrical Contractors Association (NECA)](https://www.necanet.org/): Electrical licensing standards by state relevant to solar work.
- [Solar Energy Industries Association (SEIA)](https://www.seia.org/): Industry data on installer market trends, company closures, and consumer protections.
