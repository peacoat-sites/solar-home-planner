...
What surprised me was how many homeowners don't have a baseline. They installed the system, assumed it was working, and only noticed something was wrong when their electric bill came in higher than expected six months later. If you haven't already, install a home energy monitor (the [Emporia Vue 2](https://www.amazon.com/s?k=Emporia+Vue+2+energy+monitor&tag=contentportfo-20) is around $70 and clips onto your main panel breakers) so you're tracking actual production daily, not guessing. Disclosure: the site may earn a commission on purchases through that link.
