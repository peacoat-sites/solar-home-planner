...
faqs:
  - q: "How is the solar buyback rate different from net metering?"
    a: "Net metering is a billing mechanism; the buyback rate is the specific price per kWh you receive when you export power to the grid under that mechanism. Under traditional full-retail NEM, the buyback rate equals your retail electricity rate. Under net billing or avoided-cost programs, the buyback rate is set separately and is usually lower."
  - q: "Can my utility change my buyback rate after I go solar?"
    a: "Yes, in most states it can. Some states offer a 'NEM lock-in' period, typically 10-20 years, where your compensation rate is grandfathered once you're enrolled. California's NEM 3.0 included a 9-year grandfathering period for NEM 2.0 customers. Ask your utility explicitly whether new applicants are subject to any rate-change protection."
  - q: "Does time of day affect how much I get paid for solar exports?"
    a: "It depends on your utility and rate structure. Under time-of-use rates, export credits may be higher during peak demand hours (often late afternoon and evening) and lower during off-peak hours. This can actually favor systems with west-facing panels or battery storage that shifts export timing into higher-value windows."
  - q: "Why do some solar proposals show different savings estimates than others for the same house?"
...
### How is the solar buyback rate different from net metering?

Net metering is a billing mechanism; the buyback rate is the specific price per kWh you receive when you export power to the grid under that mechanism. Under traditional full-retail NEM, the buyback rate equals your retail electricity rate. Under net billing or avoided-cost programs, the buyback rate is set separately and is usually lower.

### Can my utility change my buyback rate after I go solar?

Yes, in most states it can. Some states offer a "NEM lock-in" period, typically 10-20 years, where your compensation rate is grandfathered once you're enrolled. California's NEM 3.0 included a 9-year grandfathering period for NEM 2.0 customers. Ask your utility explicitly whether new applicants are subject to any rate-change protection.

### Does time of day affect how much I get paid for solar exports?

It depends on your utility and rate structure. Under time-of-use rates, export credits may be higher during peak demand hours (often late afternoon and evening) and lower during off-peak hours. This can actually favor systems with west-facing panels or battery storage that shifts export timing into higher-value windows.

### Why do some solar proposals show different savings estimates than others for the same house?

Often it comes down to what export rate assumption is built into the modeling software. Two proposals for the same roof can show meaningfully different annual savings if one assumes retail-rate NEM and the other uses a degraded export rate. Always ask each contractor: "What export credit rate per kWh are you using in this estimate, and can you show me where that number comes from?"

### Is a higher buyback rate always better than battery storage?

Not necessarily, but it simplifies the economics. With full retail NEM, you can essentially use the grid as a free battery, exporting surplus during the day and drawing it back at night at no penalty. When buyback rates drop significantly below retail, a physical battery becomes financially competitive even accounting for its upfront cost and cycle degradation over time.
