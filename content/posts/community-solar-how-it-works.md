...
Savings on community solar typically run between 5% and 15% on the portion of your bill covered by your subscription. That's not a huge number on any single bill, but on a $150/month electricity bill, 10% savings is $180 a year, every year, with zero installation cost and zero maintenance responsibility on your end. Some programs get you closer to the high end; others are more modest. [EnergySage's market data](https://news.energysage.com/) shows average savings around 5-15% depending on the state and the specific program terms, so anyone promising you 30% is worth questioning.
...
- [NREL also maintains research](https://www.nrel.gov/)
