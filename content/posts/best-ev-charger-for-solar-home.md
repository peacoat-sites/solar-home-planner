...
image: "https://images.pexels.com/photos/27355827/pexels-photo-27355827.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
...
faqs:
 ...
 - q: "Does my car need to be compatible with solar-aware charging?"
 a: "No. The solar awareness lives in the charger and the home energy system, not the vehicle. Any EV that accepts a J1772 plug (essentially every non-Tesla, and Teslas with an adapter) can be throttled by a smart charger without the car knowing anything special is happening."
 - q: "What if I have a flat roof or shading issues that reduce my solar production?"
 a: "This matters more than most people admit. A solar system that's regularly clipped by shading or a suboptimal tilt won't generate reliable excess for charging. Before investing in a solar-aware charger, check your inverter's production logs for consistent midday surplus. If you're seeing consistent production drops, address the shading or panel placement first."
 - q: "Do I really need a permit for a Level 2 charger?"
...
Here's what I tell people who come to me having already bought a charger that "works fine": working fine and working well are very different things.

A standard Level 2 charger will draw 7.2 to 11.5 kilowatts continuously once you plug in. If your solar system is producing 4 kW at that moment, the grid silently covers the gap. You're still running on fossil fuel electricity and paying for it. You just can't see it happening. That's the scenario most solar homeowners are stuck in, and it's completely fixable with the right charger.
...
| Charger | Max Output | Solar Integration | Bidirectional | Price Range |
|---|---|---|---|---|
| SolarEdge EV Charger | 7.2 kW | Native (SolarEdge only) | No | $500-$700 |
| Wallbox Quasar 2 | 11.5 kW | Monitor-based | Yes (V2H) | $1,500-$2,000 |
| Emporia Smart EV Charger | 9.6 kW | Via Emporia monitor | No | $250-$300 |
| ChargePoint Home Flex | 12 kW | Scheduling only | No | $600-$750 |
| Tesla Wall Connector | 11.5 kW | Native (Powerwall/Tesla) | No (standard) | $400-$500 |

Pricing reflects hardware only. Installation adds $200 to $800 depending on your panel location, conduit run, and whether you need a dedicated 60-amp circuit added.
...
**Panel proximity.** The closer your charger mounts to your main panel, the cheaper the installation. A charger on an exterior wall adjacent to the panel might cost $200 to install. A charger on the far side of a detached garage might require trenching conduit underground, easily $800 to $1,500.

**Internet connectivity.** Solar-aware charging requires your charger to communicate with something, whether that's your inverter, an energy monitor, or a cloud service. Make sure you have reliable WiFi within range of your charger location. I've seen this get overlooked constantly.

**Permit requirements.** Yes, EV charger installations require a permit in most jurisdictions. Any electrician who tells you to skip it is waving a red flag in your face. The permit protects you at resale and ensures the work meets code. Budget $50 to $150 for the permit fee.
...
- [Emporia Smart Outlet with Energy Monitoring](https://www.amazon.com/dp/B07PHBFQXQ?tag=contentportfo-20)
- [Emporia Vue Energy Monitor](https://www.amazon.com/s?k=emporia+vue+energy+monitor&tag=contentportfo-20)
- [on Amazon](https://www.amazon.com/s?k=emporia+smart+ev+charger&tag=contentportfo-20)
- [Solar Panel Cleaning Brush Kit with Extension Handle](https://www.amazon.com/dp/B0BVXGN3WK?tag=contentportfo-20)
- [Jackery SolarSaga 100W Solar Panel](https://www.amazon.com/dp/B08FX9QHLP?tag=contentportfo-20)
