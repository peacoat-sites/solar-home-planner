...
LG Chem rates the RESU10H for 60% capacity retention after 6,000 cycles at 0.5C rate. Translation for a typical daily-cycling home: you're looking at roughly 15-17 years before the battery degrades to 60% of original capacity. [EnergySage's market data](https://news.energysage.com/) shows the average homeowner who cycles their battery once daily in a self-consumption mode will hit that 6,000-cycle mark around year 16. That's a solid warranty story.
...
- [LG Energy Solution RESU Product Specifications](https://www.lgessbattery.com/us/): Official spec sheets for RESU10H, RESU16H Prime, cycle life data, and compatibility documentation.
- [National Renewable Energy Laboratory (NREL) Battery Storage Report](https://www.nrel.gov/): Analysis of residential battery economics, payback periods, and ITC impact in U.S. utility markets.
- [EnergySage Solar + Storage Marketplace Data](https://news.energysage.com/): Aggregated installer quotes and pricing trends for residential battery storage, including RESU-specific data.
- [UL 9540 Standard for Energy Storage Systems](https://www.ul.com/): Safety certification standard used for evaluating residential battery installations for permit purposes.
- California Energy Commission (CEC) Approved Battery Storage List (2026): State-specific compliance resource used by California installers and plan check reviewers.
