...
A battery sized for solar self-consumption works differently than a battery sized for emergency backup. Most calculators treat them as the same problem. They're not.
